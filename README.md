...
- **Timelapse export** — WebCodecs VideoEncoder (hardware VP9) with WebM muxing
- **Sentinel-2 STAC/COG** — real S2 L2A band ingestion (NDVI/NDWI/NBR) from Earth Search, replaces GIBS browse
...
All 40 plugins follow a unified interface (`EarthEnginePlugin`):
...
- All 40 plugins active with UI controls
